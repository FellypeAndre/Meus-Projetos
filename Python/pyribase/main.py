...
class First(App):
    def build(self):
        ...
        self.top = Label(text='', font_size=50)

        header = BoxLayout(orientation ='horizontal')
        self.bot1 = Button(text='1', font_size=30, on_press=lambda x:self.click('1'))
        self.bot2 = Button(text='2', font_size=30, on_press=lambda x:self.click('2'))
        self.bot3 = Button(text='3', font_size=30, on_press=lambda x:self.click('3'))
        self.botmais = Button(text="+", font_size=30, on_press=lambda x:self.click('+'))
        self.botsla = Button(text="<<", font_size=30, on_press=self.apagar)
        ...
        self.bot7 = Button (text='7', font_size=30, on_press=lambda x:self.click('7'))
        self.bot8 = Button (text='8', font_size=30, on_press=lambda x:self.click('8'))
        self.bot9 = Button (text='9', font_size=30, on_press=lambda x:self.click('9'))
        self.botX = Button (text='*', font_size=30, on_press=lambda x:self.click('*'))
        self.botR = Button (text='√', font_size=30, on_press=self.raiz)
        ...
        self.botengual = Button (text='=', font_size=30, on_press=self.calcular)
        self.bota = Button (text='÷', font_size=30, on_press=lambda x:self.click('÷'))

        
        footer2.add_widget(self.bot10)
        footer2.add_widget(self.bot11)
        footer2.add_widget(self.bot12)
        footer2.add_widget(self.botengual)
        footer2.add_widget(self.bota)
    ...
    def raiz(self,text):
        result = math.sqrt(int(self.top.text))
